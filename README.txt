ACreal IO is a firmware code for Arduino that allows you to program your board so that it behaves the same way as one or more Konami ACIO nodes.

Konami ACIO is a protocol used for communication between games and harware components such as e-Amusement readers.
Its uses rs232 and allows several "nodes" to be connected a single serial ports.
