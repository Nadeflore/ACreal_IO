...
#define gametype 4               //0:pop'n with card dispenser 1: pop'n, drummania(1 reader) 2:iidx/ddr/gf(2readers) 3:jubeat (1reader+Ledboard) 4: sdvx (1reader+ioboard)

#define RFID_BAUD 57600			//Baud rate for RFID Module

#define RFID_MODULE 2			//Rfid module used, 1:SL015M 2:RR10
